export const social = [
  {
    ...
    url: "https://www.linkedin.com/in/naidalyruiz/",
  },
  {
    logo: "bx bxl-github",
    url: "https://github.com/Naidev7",
  },
  {
    logo: "bx bx-download",
    url: "https://drive.google.com/file/d/1Qx6K1CzAv3A3bJCHpr6yTY2eti1GpEHI/view?usp=sharing",
  },
];
...
export const projectsData = [
  ...
  },
  {
    ...
    description:
      "This project focuses on creating professional business cards using HTML, CSS and JavaScript. The goal is to provide users with a simple and effective tool to design professional business cards directly in the browser.",
    image: "image-awesomeCards",
    color: "#428593",
    url: "https://naidev7.github.io/Awesome-profile-cards/",
  },
  {
    title: "Digital Project Showcase",
    description:
      "This project is a collaborative effort aimed at creating a digital storefront where users can view, create, and browse through a multitude of projects available on the web.",
    image: "image-nakeyogami",
    color: "#dad7cd",
  ...
  },
  {
    ...
    description:
      "This project is a teacher dashboard developed as a full-stack application, which means it encompasses both frontend and backend development. It utilizes a set of modern technologies to provide an optimal experience for users and facilitate the development and maintenance of the project.",
